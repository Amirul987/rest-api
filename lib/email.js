    ...
    try {
      const inboxGmail = `<div
        ...
        <div
            ...
            <h3>Selamat Datang Di Rest-APIs NobitaOfc</h3>
            <p>
...
Jika Kamu Memiliki Masalah, Silahkan Hubungin Saya Via <span
                    style="color: #4D96FF;"><a href="https://api.whatsapp.com/send?phone=6285749037935">WhatsApp</a></span></span>
            <span style="display: block;"><br>By,<br>NobitaOfc</span>
        </div>
    </div>
      `;
      ...
      let mailOptions = {
        from: '"NobitaOfc" <admin@nobita.xyz>',
        to: email,
        subject: 'Verify Email - Api NobitaOfc',
        html: inboxGmail,
      };
