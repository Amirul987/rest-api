...
function getvisitors() {
	...
	var url = "https://api.countapi.xyz/hit/rest-api.nobita404.xyz/visitors";
...
// User Login
$.getJSON("https://api.countapi.xyz/hit/rest-api.nobita404.xyz/userlogin", function(response) {
    $("#userlogin").text(response.value);
})

// Request Today
$.getJSON("https://api.countapi.xyz/hit/rest-api.nobita404.xyz/requesttoday", function(response) {
    $("#requesttoday").text(response.value);
})

// Total Request
$.getJSON("https://api.countapi.xyz/hit/rest-api.nobita404.xyz/totalrequest", function(response) {
